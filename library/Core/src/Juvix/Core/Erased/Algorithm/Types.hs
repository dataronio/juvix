...
getType (CatProductElimLeft _ ty) = ty
getType (CatProductElimRight _ ty) = ty
getType (CatCoproductIntroLeft _ ty) = ty
getType (CatCoproductIntroRight _ ty) = ty
getType (CatCoproductElim _ _ _ ty) = ty
getType (Unit ty) = ty
...
eraseAnn (CatProductElimLeft a _) = Erased.CatProductElimLeft (eraseAnn a)
eraseAnn (CatProductElimRight a _) = Erased.CatProductElimRight (eraseAnn a)
...
eraseAnn (CatCoproductElim cp a b _) = Erased.CatCoproductElim (eraseAnn cp) (eraseAnn a) (eraseAnn b)
