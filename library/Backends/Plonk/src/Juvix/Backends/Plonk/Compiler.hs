...
compileTerm _term@(Ann.Ann _ _ t) m a =
  case t of
    ...
    p@(Ann.CatProductElimLeftM _t1 _a1) -> panic $ show p <> "notImplemented"
    p@(Ann.CatProductElimRightM _t1 _a1) -> panic $ show p <> "notImplemented"
    ...
    p@(Ann.CatCoproductElimM _t1 _t2 _cp _a1 _a2) -> panic $ show p <> "notImplemented"
