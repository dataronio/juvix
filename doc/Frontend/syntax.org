...
#+BEGIN_SRC bnf
  ...
  ;; this let simply replaces the default global handler for functions
  ;; that have global allocating effects, into closure effects.
  let ::= let <expression>+ in <expression>
